...
namespace Modbus.ModbusFunctions
{
    ...
    public class ReadDiscreteInputsFunction : ModbusFunction
    {
        ...
        //isto kao coil samo sto je point type input
        /// <inheritdoc />
        public override Dictionary<Tuple<PointType, ushort>, ushort> ParseResponse(byte[] response)
        {
            ...
            for (int i = 0; i < q; i++)
            {
                ...
                for (int j = 0; j < 8; j++)
                {
                    ...
                    d.Add(new Tuple<PointType, ushort>(PointType.DIGITAL_INPUT, (ushort)(paramCom.StartAddress + j + i * 8)), v); //dodajemo u recnik
                }
            }
            return d;
        }
