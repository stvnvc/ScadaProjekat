...
namespace Modbus.ModbusFunctions
{
    ...
    public class ReadInputRegistersFunction : ModbusFunction
    {
        ...
        //identicno kao kod citanja holding registara (ovde input tamo output)
        /// <inheritdoc />
        public override Dictionary<Tuple<PointType, ushort>, ushort> ParseResponse(byte[] response)
        {
            ...
            for (int i = 0; i < byteCount / 2; i++)
            {
                ...
                ushort value = BitConverter.ToUInt16(new byte[] { byte2, byte1 }, 0); //spajamo 2 bajta u jedan ushort

                d.Add(new Tuple<PointType, ushort>(PointType.ANALOG_INPUT, address), value);
